...
/*
	Usage: slider_options_get_meta( 'slider_options_slide_title' )
	Usage: slider_options_get_meta( 'slider_options_slide_short_description' )
	Usage: slider_options_get_meta( 'slider_options_button_text' )
	Usage: slider_options_get_meta( 'slider_options_button_url' )
*/
	    ...
	    if ( $loop->have_posts() ) :
	        ...
	        <div class="slide-main" style="background: url(<?php echo $src[0]; ?>) center/cover no-repeat !important;">
						...
						<div class="slide-container">
							...
							<?php if($buttonTitle) : ?>
								<a href="<?php echo $buttonLink; ?>" class="slide-button"><?php echo $buttonTitle; ?></a>
							<?php endif; ?>
						</div>
	        </div>
	    	<?php endwhile; ?>
