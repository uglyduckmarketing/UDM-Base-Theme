...
function display_theme_panel_fields() {
  ...
  */
  ...
  add_settings_section("section", "Homepage Settings", null, "home-options");
  ...
  //Social Settings
  udm_register_field_settings("ninj_form", "Contact Form Shortcode", "display_ninjaform", "social-options", "section");
